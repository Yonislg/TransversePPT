...
function jxe_v2 = total_current(x, plasma_properties,design_parameters, phi_A, phi_C,u_ze, d_J, F_SEE, F_FEE,fix)
    %% prepping script
...
if F_FEE
    ...
    % Continuity equation
    jxe_v2(4) = -2*sqrt(Te/m_i) + (ge_bolz(ne_0, Te, -x(2)*Te/e) - x(4)- x(3) + ge_bolz(ne_0, Te, -x(1)*Te/e))/ne_0; %
